      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        {filteredAppointments.length === 0 ? (
          <div className="text-center py-16 text-neutral-500 space-y-2">
            <CalendarIcon className="w-10 h-10 mx-auto text-neutral-600 opacity-50" />
            <p className="text-sm font-medium">No se encontraron citas con los filtros seleccionados.</p>
            <button
              onClick={() => {
                setSearchQuery('');
